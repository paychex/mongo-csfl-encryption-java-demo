...
/*
	...
	created on 1/21/20
*/
@Document("autoEncryptedPerson")
public class AutoEncryptedPerson {
	...
	public AutoEncryptedPerson() {}

	public AutoEncryptedPerson(String firstName, String lastName) {
		this.firstName = firstName;
		this.lastName = lastName;
	}

	public AutoEncryptedPerson( String firstName, String lastName, int ssn, String phone, String bloodType) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.ssn = ssn;
		this.phone = phone;
