...
package com.paychex.mongo.enterprise.respository;
...
/*
	...
	created on 1/21/20
*/
public interface EncryptedPersonRepository extends MongoRepository<AutoEncryptedPerson, String> {
	public AutoEncryptedPerson findByFirstName(String firstName);
	public AutoEncryptedPerson findBySsn(int ssn);
}
