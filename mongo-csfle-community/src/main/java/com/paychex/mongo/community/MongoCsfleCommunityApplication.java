...
package com.paychex.mongo.community;

import com.paychex.mongo.community.handler.PersonHandler;
...
public class MongoCsfleCommunityApplication implements CommandLineRunner {

	@Autowired
	private PersonHandler handler;

	Logger logger = LoggerFactory.getLogger(MongoCsfleCommunityApplication.class);
	public static void main(String[] args) {
		SpringApplication.run(MongoCsfleCommunityApplication.class, args);
	}
